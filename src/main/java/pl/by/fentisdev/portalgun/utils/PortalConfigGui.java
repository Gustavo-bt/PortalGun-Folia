...
public class PortalConfigGui {
    ...
    public void setup(){
        if (gui==null){
            gui = new InventoryGUI("PortalGun Config", 3, new InventoryClickEventHandler() {
                ...
                public void onInventoryClose(InventoryGUICloseEvent e) {
                    e.getPlayer().sendMessage("Â§aSaving PortalGun Config.");
        ...
        if (guiRecipe==null){
            guiRecipe = new InventoryGUI("PortalGun Recipe", 3, new InventoryClickEventHandler() {
                    ...
                    if (e.guiInventory()){
                        if (e.getSlot()<2||
                            ...
                            if (e.getSlot()==0){
                                ...
                                guiRecipe.setItem(0,PortalConfig.getInstance().canCraft(pm)?new ItemCreator(Material.GREEN_WOOL).setDisplayName("Â§aCan Craft"):new ItemCreator(Material.RED_WOOL).setDisplayName("Â§cCan Craft"));
                            }
                        }else{
                            e.setCancelled(true);
                ...
                @Override
                public void onInventoryClose(InventoryGUICloseEvent e) {
                    e.getPlayer().sendMessage("Â§aSaving PortalGun Recipe.\nÂ§cRestart required!");
                    ...
                    SchedulerUtil.runTaskLaterForPlayer(PortalGunMain.getInstance(), e.getPlayer(), () -> {
                        open(e.getPlayer());
                    }, 1);
                }
            }, PortalGunMain.getInstance());
        ...
        if (guiWhitelist==null){
            guiWhitelist = new InventoryGUI("Whitelist Blocks", 6, new InventoryClickEventHandler() {
                ...
                @Override
                public void onInventoryClose(InventoryGUICloseEvent e) {
                    e.getPlayer().sendMessage("Â§aSaving WhitelistBlocks");
                    SchedulerUtil.runTaskLaterForPlayer(PortalGunMain.getInstance(), e.getPlayer(), () -> {
                        open(e.getPlayer());
                    }, 1);
                }
    ...
    public void update(){
        ...
        gui.clear();
        for (int i = 0; i < 3*9; i++) {
            gui.setItem(i,new ItemCreator(Material.WHITE_STAINED_GLASS_PANE).setDisplayName("Â§a"));
        }
        gui.setItem(10,PortalConfig.getInstance().isInterdimensional()?new ItemCreator(Material.GREEN_WOOL).setDisplayName("Â§aInterdimensional"):new ItemCreator(Material.RED_WOOL).setDisplayName("Â§cInterdimensional"));
        gui.setItem(11,PortalConfig.getInstance().canGrabEntity()?new ItemCreator(Material.GREEN_WOOL).setDisplayName("Â§aCan Grab Entities"):new ItemCreator(Material.RED_WOOL).setDisplayName("Â§cCan Grab Entities"));
        gui.setItem(12,new ItemCreator(Material.FILLED_MAP).setDisplayName("Â§aWhitelist Blocks"));
        gui.setItem(13,new ItemCreator(Material.COMPASS).setDisplayName("Â§aShoot Range: <"+PortalConfig.getInstance().getPortalShootRange()+">"));
        gui.setItem(14,new ItemCreator(Material.CRAFTING_TABLE).setDisplayName("Â§aRecipes").setLore("Â§cRestart required for apply any changes"));
        gui.setItem(15,PortalConfig.getInstance().cameraChangeDirection()?new ItemCreator(Material.GREEN_WOOL).setDisplayName("Â§aCamera Change Direction"):new ItemCreator(Material.RED_WOOL).setDisplayName("Â§cCamera Change Direction"));
    }
    ...
    public void updatePortalGunRecipe(PortalModel po){
        ...
        guiRecipe.clear();
        for (int i = 0; i < 3*9; i++) {
            guiRecipe.setItem(i,new ItemCreator(Material.WHITE_STAINED_GLASS_PANE).setDisplayName("Â§a"));
        }
        guiRecipe.setItem(0,PortalConfig.getInstance().canCraft(po)?new ItemCreator(Material.GREEN_WOOL).setDisplayName("Â§aCan Craft"):new ItemCreator(Material.RED_WOOL).setDisplayName("Â§cCan Craft"));
    ...
    public void updateWhitelist(){
        ...
        guiWhitelist.clear();
        for (int i = 0; i < 9; i++) {
            guiWhitelist.setItem(i,new ItemCreator(Material.WHITE_STAINED_GLASS_PANE).setDisplayName("Â§a"));
        }
        guiWhitelist.setItem(0,PortalConfig.getInstance().whiteList()?new ItemCreator(Material.LIME_WOOL).setDisplayName("Â§aWhitelist On"):new ItemCreator(Material.RED_WOOL).setDisplayName("Â§cWhitelist Off"));
    ...
    public void open(Player p){
        ...
        if (gui.getInventory().getViewers().size()>0){
            p.sendMessage("Â§cAnother player is using the menu!");
            return;
        }
        p.closeInventory();
        gui.open(p);
    ...
    public void openPortalGunSelector(Player p){
        ...
        for (int i = 0; i < 3*9; i++) {
            inv.setItem(i,new ItemCreator(Material.WHITE_STAINED_GLASS_PANE).setDisplayName("Â§a"));
        }
        inv.setItem(0,PortalConfig.getInstance().portalCraftable()?new ItemCreator(Material.GREEN_WOOL).setDisplayName("Â§aCan Craft Portal Guns"):new ItemCreator(Material.RED_WOOL).setDisplayName("Â§cCan Craft Portal Guns"));
    ...
    public void openWhitelist(Player p){
        ...
        p.closeInventory();
        SchedulerUtil.runTaskLaterForPlayer(PortalGunMain.getInstance(), p, () -> guiWhitelist.open(p), 1);
    }
}
